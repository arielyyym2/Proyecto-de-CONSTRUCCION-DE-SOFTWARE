...
if ($factura['estado'] === 'anulada') {
    echo '<script>alert("No se puede editar una factura anulada"); window.location.href="index.php";</script>';
    exit;
}
...
if (isset($_POST['btnActualizar'])) {
    ...
    if ($facturaController->actualizar($facturaId, $datosFactura, $detallesNuevos)) {
        header("Location: index.php");
        exit;
    }
}
...
<head>
    <meta charset="UTF-8">
    <title>Editar Factura - Papelería</title>
...
<body>
    <div class="container-fluid">
        <div class="d-flex justify-content-between align-items-center p-3 bg-light">
            <h1>
                Editar Factura
                <span class="badge bg-secondary"><?= htmlspecialchars($factura['numero_factura']) ?></span>
            </h1>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            value="<?= htmlspecialchars($factura['cliente_identificacion']) ?>"
                                            required>
                                    </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <div id="detallesContainer">
                                    <!-- Las líneas existentes se cargarán aquí -->
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <textarea class="form-control"
                                    name="notas"
                                    rows="3"
                                    placeholder="Observaciones o notas sobre la factura..."><?= htmlspecialchars($factura['notas'] ?? '') ?></textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="totales-box">
                            ...
                            <div class="mb-3">
                                ...
                                <select name="estado" class="form-select">
                                    <option value="pendiente" <?= $factura['estado'] == 'pendiente' ? 'selected' : '' ?>>
                                        Pendiente
                                    </option>
                            ...
                            <button type="submit"
                                ...
                                <i class="fa-solid fa-save"></i> Actualizar Factura
                            </button>
    ...
    <script>
        ...
        // Detalles existentes desde PHP
        const detallesExistentes = <?= json_encode($detalles) ?>;

        // Agregar línea de detalle
        function agregarLinea(producto = '', cantidad = 1, precio = 0) {
            lineaCounter++;
